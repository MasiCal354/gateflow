...
class HttpApiSigningClient(BaseApiSigningClient):
    ...
    def _handle_response(response):
        ...
        try:
            ...
            raise BinanceChainRequestException(
    ...
    def authenticate(self):
        ...
        if not self._token:
            raise BinanceChainSigningAuthenticationException(
                "Invalid username and password")

    def sign_order(self, msg: binance_chain.messages.NewOrderMsg,
                   wallet_name: str):
    ...
    def broadcast_order(
            self, msg: binance_chain.messages.NewOrderMsg, wallet_name: str):
    ...
    def sign_transfer(
            self, msg: binance_chain.messages.TransferMsg, wallet_name: str):
        """Sign a message using a signing service
    ...
    def sign_freeze(self, msg: binance_chain.messages.FreezeMsg,
                    wallet_name: str):
        """Sign a message using a signing service
    ...
    def broadcast_freeze(
            self, msg: binance_chain.messages.FreezeMsg, wallet_name: str):
        """Sign and broadcast a message using a signing service
    ...
    def sign_unfreeze(
            self, msg: binance_chain.messages.UnFreezeMsg, wallet_name: str):
        """Sign a message using a signing service
    ...
    def broadcast_vote(
            self, msg: binance_chain.messages.VoteMsg, wallet_name: str):
        """Sign and broadcast a message using a signing service
