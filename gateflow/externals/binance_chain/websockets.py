...
class ReconnectingWebsocket:
    ...
    async def _reconnect(self):
        ...
        if self._reconnect_attempts < self.MAX_RECONNECTS:
            ...
            self._log.debug(
                f"websocket reconnecting {self.MAX_RECONNECTS - self._reconnect_attempts} attempts left")
            ...
            self._log.error(
                f"websocket could not reconnect after {self._reconnect_attempts} attempts")
            pass
