    ...
    def _handle_response(self):
        ...
        try:
            ...
            raise BinanceRequestException(
                'Invalid Response: %s' % self.response.text)
...
"""
    ...
    def futures_liquidation_orders(self, **params):
        ...
        """
        return self._request_futures_api(
            'get', 'ticker/allForceOrders', data=params)
    ...
    def futures_open_interest(self, **params):
        ...
        """
        return self._request_futures_api(
            'get', 'ticker/openInterest', data=params)
    ...
    def futures_leverage_bracket(self, **params):
        ...
        """
        return self._request_futures_api(
            'get', 'ticker/leverageBracket', data=params)
    ...
    def futures_change_margin_type(self, **params):
        ...
        """
        return self._request_futures_api(
            'post', 'marginType', True, data=params)
