...
_STDSIGNATURE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pub_key',
            full_name='transaction.StdSignature.pub_key',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='signature',
            full_name='transaction.StdSignature.signature',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='account_number',
            full_name='transaction.StdSignature.account_number',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='sequence',
            full_name='transaction.StdSignature.sequence',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
